...
* On Python 3.11+, ``leapp.compile_graph(visualize=True)`` writes SVG and PNG
  graph images that are useful for checking node connectivity. Python 3.10
  emits a warning and skips these artifacts.
